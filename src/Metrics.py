...
class Metrics(object):
    ...
    def errorRatio(self):
        ...
        """
        return self.momet.errorRatio(self.solutions[self.a][self.aIdx], self.paretoOptimal)
    ...
    def generationalDistance(self):
        ...
        """
        return self.momet.generationalDistance(self.solutions[self.a][self.aIdx], self.paretoOptimal)

    def spacing(self):
        """
        Computes the spacing of the obtained solution set.
        """
        return self.momet.spacing(self.solutions[self.a][self.aIdx])
        
    def hypervolume(self):
        """
        Computes the hypervolume value of the obtained solution set.
        """
        return self.momet.hypervolume(self.solutions[self.a][self.aIdx], self.hypervolumeReference)

    def coverage(self):
        """
        Computes the coverage value of two obtained solution sets.
        """
        return self.momet.coverage(self.solutions[self.a][self.aIdx], self.solutions[self.b][self.bIdx])
        
    def additiveEpsilon(self):
        """
        Computes the additive epsilon indicator from one obtained solution set to other solution set.
        """
        return self.momet.additiveEpsilon(self.solutions[self.a][self.aIdx], self.solutions[self.b][self.bIdx])
    ...
    def multiplicativeEpsilon(self):
        ...
        """
        return self.momet.multiplicativeEpsilon(self.solutions[self.a][self.aIdx], self.solutions[self.b][self.bIdx])
